    ...
    <section className="max-w-6xl mx-auto p-6">
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
          ...
          svängningar i stämningsläget. Personer med sjukdomen upplever perioder
          av depression och mani eller hypomani. Här kan du läsa mer om symtom,
          olika typer av diagnos och få svar på vanliga frågor om sjukdomen.
        </p>
      </div>
