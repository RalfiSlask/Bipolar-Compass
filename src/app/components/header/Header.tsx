...
const Header = () => {
  ...
  return (
    <header className="relative z-[50] w-full h-[70px] xl:h-[160px] gap-4 border-b-2 border-primary-medium shadow-md bg-white flex flex-col items-center text-black">
