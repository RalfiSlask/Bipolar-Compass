      ...
      <div className="flex flex-wrap gap-3">
        {links.googleBooks && (
          <a
            ...
            className="inline-flex items-center gap-1 px-4 py-1 rounded-lg border border-dark hover:bg-primary-light transition-colors"
          >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1 px-4 py-1 text-white border border-[#D60D0D] rounded-lg bg-[#D60D0D] hover:bg-[#D60D0D]/80 transition-colors"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1 px-4 py-1 bg-[#f60] text-white rounded-lg border border-orange-600 hover:bg-orange-600 hover:text-white transition-colors"
        >
          <Image
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1 px-4 py-1 text-dark rounded-lg border border-dark hover:bg-primary-light transition-colors"
        >
          <Image
