...
const MyPage = () => {
  ...
  const ICONS = [
    FaLaughBeam, // Ingen
    FaGrinBeam, // Mycket mild
    FaSmile, // Mild
    FaMeh, // Måttlig
    FaFrown, // Stark
    FaSadTear, // Mycket stark
  ];
  ...
  return (
    <section className="flex flex-col items-center w-full h-full p-6 bg-primary-light">
      <h2 className="text-2xl md:text-3xl text-primary-dark mb-8">
        Välkommen till Din Sida {session?.user?.name}
      </h2>

      <div className="w-full max-w-2xl bg-white p-6 rounded-lg shadow-md mb-8">
        <h2 className="text-xl font-semibold text-primary-dark mb-4">Profil</h2>
