...
const NotFound = () => {
  return (
    <section className="flex flex-col items-start gap-6 pt-20">
      <h2 className="h-xl text-green-lightest mb-4 text-center sm:text-left">
      ...
      <div className="w-full flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          <h3 className="h-xs text-green-lightest">Vad det kan bero på</h3>
          <ul className="w-full">
        ...
        <div className="flex flex-col gap-2">
          <h3 className="h-xs text-green-lightest">
            För att fixa detta kan du
          </h3>
          <ul className="w-full">
      ...
      <p className="w-full flex items-center flex-wrap">
        ...
        <Link
          className="underline hover:text-green-light inline-flex items-center"
          href="/om-oss/kontakt"
        >
          <LinkIcon />
